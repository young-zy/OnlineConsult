...
CREATE TABLE IF NOT EXISTS `consult`.`question` (
  ...
  `question_content` VARCHAR(45) CHARACTER SET 'utf8mb4' NOT NULL COMMENT '问题内容',
  `answer_uid` INT NULL COMMENT '回答者uid',
  `answer_content` VARCHAR(45) CHARACTER SET 'utf8mb4' NULL COMMENT '回答内容',
